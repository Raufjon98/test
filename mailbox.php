                    ...
                    <div class="mail-box">
                        ...
                        <table class="table table-hover table-mail">
                            ...
                            <tr class="unread">
                                ...
                                <td class="mail-subject"><a href="mail_detail.html">Aldus PageMaker including versions
                                        of Lorem Ipsum.</a></td>
                                <td class=""></td>
                            ...
                            <tr class="read">
                                ...
                                <td class="mail-subject"><a href="mail_detail.html">There are many variations of
                            ...
                            <tr class="read">
                                ...
                                <td class="mail-ontact"><a href="mail_detail.html">Patrick Pertners</a> <span
                                            class="label label-info pull-right">Adv</span></td>
                                <td class="mail-subject"><a href="mail_detail.html">If you are going to use a passage of
                                        Lorem </a></td>
                                <td class=""></td>
                                <td class="text-right mail-date">May 28</td>
                            </tr>
                            <tr class="read">
                                ...
                                <td class="mail-subject"><a href="mail_detail.html">Humour, or non-characteristic words
                                        etc.</a></td>
                                <td class=""></td>
                            ...
                            <tr class="read">
                                ...
                                <td class="mail-subject"><a href="mail_detail.html">Oor Lorem Ipsum is that it has a
